function Cookie(location, maxCustomers, minCustomers, avgCookies, hours, total, numOfCookiesPurHour) {
    ...
    this.hours = hours;
    this.total = total;
    this.numOfCookiesPurHour = numOfCookiesPurHour;

}
var stand = new Cookie("the location of this stand is " );
